...
const EditorDemoSection = () => {
  return (
    <section
      ...
      className="relative overflow-hidden bg-gradient-to-br from-blue-900 via-slate-900 to-slate-950 px-4 py-24 text-white sm:px-6 lg:px-8"
    >
      {/* Glow orbs */}
      <div className="pointer-events-none absolute inset-0">
        <div className="animate-parallax-float absolute -top-20 right-10 h-[400px] w-[400px] rounded-full bg-blue-500/15 blur-3xl" />
        <div
          className="animate-parallax-float absolute bottom-10 left-10 h-[350px] w-[350px] rounded-full bg-cyan-400/10 blur-3xl"
          style={{ animationDelay: "-4s" }}
        />
        <div
          className="animate-parallax-float absolute top-1/2 left-1/2 h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-500/10 blur-3xl"
        ...
        >
          {features.map(f => (
            <StaggerItem key={f.title}>
              <div className="card-premium-dark glass-shimmer rounded-2xl p-6">
        ...
        <ScrollReveal delay={0.2}>
          <div className="mt-12 grid gap-8 lg:grid-cols-[2fr_1fr]">
            <div className="rounded-3xl border border-slate-700/50 bg-slate-950/70 p-6 backdrop-blur-sm">
              {/* Outer glow on video */}
              <div className="mb-6 overflow-hidden rounded-2xl border border-slate-700/40 bg-slate-900/80 shadow-2xl shadow-blue-500/5">
                <video
            ...
            <div className="space-y-4">
              <div className="card-premium-dark rounded-2xl p-5">
                <p className="text-xs font-bold tracking-[0.25em] text-slate-400 uppercase">
                  Summary
                </p>
                <div className="mt-5 space-y-3 text-sm">
                  <div className="flex items-center justify-between rounded-xl bg-slate-800/80 px-4 py-3.5 ring-1 ring-slate-700/40">
                    <span className="font-medium">AI Originality</span>
                    <span className="font-bold text-blue-200">15%</span>
                  </div>
                  <div className="flex items-center justify-between rounded-xl bg-slate-800/80 px-4 py-3.5 ring-1 ring-slate-700/40">
                    <span className="font-medium">Source Matches</span>
                    <span className="font-bold text-rose-200">2</span>
                  </div>
                  <div className="flex items-center justify-between rounded-xl bg-slate-800/80 px-4 py-3.5 ring-1 ring-slate-700/40">
              ...
              <div className="card-premium-dark rounded-2xl p-5">
                ...
                <div className="mt-5 space-y-3 text-sm text-slate-300">
                  <div className="rounded-xl border border-slate-700/40 bg-slate-900/70 p-3.5">
