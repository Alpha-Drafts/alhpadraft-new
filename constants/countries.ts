/**
 * This file contains a list of country data used throughout the application.
 * Each country entry includes its name, flag emoji, ISO country code, and international dialing code.
 * The COUNTRIES constant can be used for country selectors, phone number validation, and similar features.
 */
 ...
 * Each object provides the country's name, flag, ISO code, and dial code.
 */
